...
app.post('/api/inventory-items', async (req, res) => {
    const params = [
        { name: 'inventory_item_id', type: sql.Int, value: req.body.inventory_item_id || null },
        ...
        { name: 'current_stock_level', type: sql.Decimal, value: req.body.current_stock_level },
        { name: 'reorder_point', type: sql.Decimal, value: req.body.reorder_point },
        { name: 'max_stock_level', type: sql.Decimal, value: req.body.max_stock_level || null },
        { name: 'supplier_info', type: sql.NVarChar, value: req.body.supplier_info || null },
        { name: 'cost_per_unit', type: sql.Decimal, value: req.body.cost_per_unit },
        { name: 'location', type: sql.NVarChar, value: req.body.location || null },
        { name: 'created_by', type: sql.Int, value: req.body.created_by },
        { name: 'project_id', type: sql.Int, value: req.body.project_id }
    ];
...
app.put('/api/inventory-items/:id', async (req, res) => {
    ...
    const params = [
        { name: 'inventory_item_id', type: sql.Int, value: req.body.inventory_item_id },
        { name: 'item_name', type: sql.NVarChar, value: req.body.item_name },
        { name: 'part_number', type: sql.NVarChar, value: req.body.part_number },
        { name: 'description', type: sql.NVarChar, value: req.body.description },
        { name: 'category', type: sql.NVarChar, value: req.body.category },
...
app.post('/api/cart/add', async (req, res) => {
    try {
        ...
        const result = await pool.request()
            .input('user_id', sql.Int, userId)
            .input('inventory_item_id', sql.Int, itemId)
            .input('quantity_requested', sql.Decimal, quantity_requested)
            .input('estimated_cost', sql.Decimal, estimated_cost || null)
